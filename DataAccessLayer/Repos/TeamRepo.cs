    ...
    public class TeamRepo : ITeamRepo
    {
        ...
        public Team GetTeamById(int id)
        {
            ...
            var cmd = new MySqlCommand(
                "SELECT t.id, t.name, u.id AS captain_id, u.username " +
                "FROM team t JOIN user u ON t.captain_id = u.id WHERE t.id = @id",
                conn.GetInnerConn());
        ...
        public Team GetTeamByUser(int userId)
        {
            ...
            var cmd = new MySqlCommand(
                "SELECT t.id, t.name, t.captain_id, u.username " +
                "FROM team_player tp " +
        ...
        public List<Team> GetAllTeams()
        {
            ...
            var cmd = new MySqlCommand(
                "SELECT t.id, t.name, u.id AS captain_id, u.username " +
                "FROM team t JOIN user u ON t.captain_id = u.id",
                conn.GetInnerConn());
        ...
        public List<TeamJoinRequest> GetRequestsForTeam(int teamId)
        {
            ...
            var cmd = new MySqlCommand(
                "SELECT r.id, r.user_id, r.team_id, r.requested_at, u.username " +
        ...
        public List<TeamJoinRequest> GetRequestsForUser(int userId)
        {
            ...
            var cmd = new MySqlCommand(
                "SELECT r.id, r.team_id, r.user_id, r.requested_at " +
                "FROM team_join_request r WHERE r.user_id=@uid",
                conn.GetInnerConn());
